    ...
    render() {
        return (
            <div className="ui segment">
                <div className="ui segment">
                    <h4><i className="angle right icon" />Chcesz zadbać o bezpieczeństwo swojego dziecka?</h4>
                ...
                <div className="ui segment">
                    <h4><i className="angle right icon" />GdzieJestMojeDziecko? jest bardzo przyjazną aplikacją.</h4>
                ...
                <div className="ui segment">
                    <h4><i className="angle right icon" />Zostaniesz szybko poinformowany o sytuacji niezaplanowanej.</h4>
